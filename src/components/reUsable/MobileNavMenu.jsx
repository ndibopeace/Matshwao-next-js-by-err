...
export default function HamburgerMenu() {
  ...
  const shareText =
    "Hey! I found this really useful website for learning the driving theory test. It has helpful notes and practice questions and I think you might find it useful too: https://matshwao.pages.dev";
  const socialLinks = {
    facebook:
